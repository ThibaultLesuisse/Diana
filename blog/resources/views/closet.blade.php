...
@section('content')
    <div class="container">
        <div class="page-header">
            <h1>Here you can manage your personal closet</h1>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <img src="img/wasmand.png" class="img-circle" data-toggle="tooltip" title="Drag and drop clothes that need some washing!" />
        </div>
    </div>
</body>
